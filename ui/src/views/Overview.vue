          ...
          <div class="pressure-towers-wrap pressure-towers-wide-wrap">
            <div class="pressure-tower-card pressure-wide-card">
              ...
              <div class="pressure-tower pressure-tower-data-inner pressure-tower-wide">
                <div class="pressure-tower-freezone" :style="{ height: `${100 - glance.memory.percentUsed}%` }">
                  <div class="pressure-free-copy">{{ formatBytes(glance.memory.total - glance.memory.used) }} free</div>
                </div>
                <div class="pressure-tower-fill mem-fill pressure-tower-fill-data" :style="{ height: `${glance.memory.percentUsed}%` }">
                  <div class="pressure-fill-copy">
                    <strong>{{ glance.memory.percentUsed }}%</strong>
                  </div>
                </div>
              </div>
            </div>
            <div class="pressure-tower-card pressure-wide-card">
              ...
              <div class="pressure-tower pressure-tower-data-inner pressure-tower-wide">
                <div class="pressure-tower-freezone" :style="{ height: `${100 - glance.storage.percentUsed}%` }">
                  <div class="pressure-free-copy">{{ formatBytes(glance.storage.free) }} free</div>
                </div>
                <div class="pressure-tower-fill storage-fill pressure-tower-fill-data" :style="{ height: `${glance.storage.percentUsed}%` }">
                  <div class="pressure-fill-copy">
                    <strong>{{ glance.storage.percentUsed }}%</strong>
                  </div>
                </div>
              </div>
            </div>
