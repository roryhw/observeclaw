...
export function initDB() {
  ...
  `;
    ...
    try {
        db.exec('ALTER TABLE alert_rules ADD COLUMN dedupeSec INTEGER NOT NULL DEFAULT 600;');
    }
    catch { }
    try {
        db.exec('ALTER TABLE alert_rules ADD COLUMN notifyEnabled INTEGER NOT NULL DEFAULT 0;');
    }
    catch { }
    try {
        db.exec('ALTER TABLE alert_rules ADD COLUMN notifyChannel TEXT;');
    }
    catch { }
    try {
        db.exec('ALTER TABLE alert_rules ADD COLUMN notifyCooldownSec INTEGER NOT NULL DEFAULT 900;');
    }
    catch { }
    try {
        db.exec('ALTER TABLE alert_rules ADD COLUMN lastNotifiedAt TEXT;');
    }
    catch { }
