export type PulseState = 'IDLE' | 'COLLABORATING' | 'THINKING' | 'BUILDING' | 'DEGRADED' | 'DISCONNECTED';
export type PulseReason = 'runtime_unreachable' | 'telemetry_stale' | 'tool_activity' | 'model_active' | 'message_flow' | 'no_active_work';
